          ...
          <div className="w-full md:w-7/12 space-y-4 sm:text-base text-sm ">
            <div className="font-Header ">
              <span className="text-gray-400  tracking-wide">
                Hello! My name is Milkhail Alif and I enjoy solving problems and
                ...
                <span className="text-AAsecondary">
                optimized, user-friendly, sophisticated websites</span>.
              </span>
            </div>
            <div className="font-Header tracking-wide">
              <span className="text-gray-400  ">
                For 8 years of experience about full stack development, could
                provide wonderful{" "}
              ...
              <span className="text-gray-400  ">
                ...
                , also
                <span className="text-AAsecondary"> full time employee</span> and
                Passion and enthusiasm of development, push me to boost &
                teach myself. <br className="md:block hidden" />
                Experienced in Web development which is performing over the internet.
              </span>
            </div>
